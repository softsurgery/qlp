...
import validateConfig from 'src/shared/database/utils/validate-config';
...
class EnvironmentVariablesValidator {
  ...
  @ValidateIf((envValues: Record<string, string>) => !envValues.DATABASE_PASSWORD)
  @IsString()
  ...
  @ValidateIf((envValues: Record<string, string>) => !envValues.DATABASE_USERNAME)
  @IsString()
