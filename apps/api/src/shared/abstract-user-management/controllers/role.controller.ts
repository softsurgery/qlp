...
export class RoleController {
  ...
  async findAllPaginated(@Query() query: IQueryObject): Promise<PageDto<ResponseRoleDto>> {
  ...
  async update(
    ...
    const role = await this.roleService.updateWithPermissions(id, updateRoleDto);
